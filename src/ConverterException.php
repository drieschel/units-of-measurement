...
class ConverterException extends \Exception
{
    ...
    {
        return new static(sprintf('Unit "%s [%s]" can not converted into "%s [%s]"', $fromUnit->getName(), $fromUnit->getSymbol(), $toUnit->getName(), $toUnit->getSymbol()), self::INCOMPATIBLE_UNITS);
    }
}
